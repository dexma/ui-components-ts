    ...
    describe('AntdRangePicker', () => {
        ...
        describe('Days', () => {
            ...
            it('should change values of start and end date when a preset range is clicked', async () => {
                ...
                // Then
                expect(onChangeFunction).toBeCalledTimes(1);
                expect(await screen.findByDisplayValue(dayjs().startOf('month').format('DD/MM/YYYY'))).toBeTruthy();
                expect(await screen.findByDisplayValue(dayjs().endOf('month').format('DD/MM/YYYY'))).toBeTruthy();
            });
            it('should change values of start and end date when "15" and "16" numbers are selected on dropdown menu', async () => {
                ...
                // Then
                expect(onChangeFunction).toBeCalledTimes(1);
                expect(await screen.findByDisplayValue(dayjs().date(daySelected).format('DD/MM/YYYY'))).toBeTruthy();
                expect(await screen.findByDisplayValue(dayjs().date(nextDaySelected).format('DD/MM/YYYY'))).toBeTruthy();
            });
        });
        describe('Month', () => {
            it('should change start date input value and end date input value when values are entered', async () => {
            ...
            it('should change values of start and end date when a preset range is clicked', async () => {
                ...
                // Then
                expect(onChangeFunction).toBeCalledTimes(1);
                expect(await screen.findByDisplayValue(expectedCurrentMonth)).toBeTruthy();
        ...
        describe('Year', () => {
            ...
            it('should change values of start and end date when a preset range is clicked', async () => {
                ...
                // Then
                expect(onChangeFunction).toBeCalledTimes(1);
                expect(await screen.findByDisplayValue(expectedCurrentYear)).toBeTruthy();
        ...
        describe('Days and time', () => {
            ...
            it('should change values of start and end datetime when a preset range is clicked', async () => {
                ...
                // Then
                expect(onChangeFunction).toBeCalledTimes(1);
                expect(await screen.findByDisplayValue(dayjs().startOf('day').format('DD/MM/YYYY HH:mm'))).toBeTruthy();
                expect(await screen.findByDisplayValue(dayjs().endOf('day').format('DD/MM/YYYY HH:mm'))).toBeTruthy();
            });
        });
    });
});
