...
const StyledTabs = styled.div<StyledTabsProps>`
    ...
    .ant-tabs.ant-tabs-card .ant-tabs-card-bar .ant-tabs-tab .ant-tabs-close-x {
        ...
        font-size: ${(props) => tabFontSize(props.theme)};
    ...
    .ant-tabs-tab-next-icon {
        ...
        top: 50%;
        left: 50%;
        font-weight: ${(props) => fontWeightBold(props.theme)};
        font-style: normal;
        font-variant: normal;
        line-height: inherit;
        text-align: center;
    ...
    .ant-tabs-nav {
        ...
        box-sizing: border-box;
        margin: ${(props) => (props.$variant === 'scrollable' ? '0' : '0px 0px 16px 0px')};
        padding-left: 0;
        list-style: none;
    ...
    .ant-tabs-nav .ant-tabs-tab:hover {
        color: ${(props) => (props.$variant === 'scrollable' ? gray700(props.theme) : primaryColor(props.theme))};
    }
    ...
    .ant-tabs {
        height: ${(props) => (props.$variant === 'scrollable' ? '100%' : 'auto')};
        display: ${(props) => (props.$variant === 'scrollable' ? 'flex' : null)};
        flex-direction: ${(props) => (props.$variant === 'scrollable' ? 'column' : null)};
    }
    ...
    .ant-tabs-ink-bar {
        position: absolute;
        background: ${(props) => primaryColor(props.theme)};
        pointer-events: none;
    }
    .ant-tabs-tab {
        position: relative;
